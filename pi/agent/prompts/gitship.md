...
4. If there are concerns, stop and ask me for confirmation before continuing. Use the `ask_user` tool for any questions, confirmations, or clarifications you need from me, grouping related questions in one call where practical. In that confirmation request, summarize:
   - what you found
