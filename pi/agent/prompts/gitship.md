...
4. If there are concerns, stop and ask me for confirmation before continuing. Use the `ask_user_question` tool for any questions, confirmations, or clarifications you need from me, grouping related questions in one call where practical. In that confirmation request, summarize:
   - what you found
...
- Use the `ask_user_question` tool whenever you need user confirmation or clarification.
